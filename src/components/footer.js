        ...
        <Box sx = {{color: "rgba(255, 255, 255, 0.48)"}}>
            ...
            <Box sx={{ display: "flex", flexDirection: "column", backgroundColor: "hsl(0, 0.00%, 12%)", justifyContent: "center", paddingTop: "1rem" }}>
                ...
                <Box sx={{ display: "flex", "justifyContent": "center", py: "0.3rem"}}>
                    <IconButton href = "https://twitter.com/codeiiest" target="_blank" rel="noopener noreferrer" className="iconhover" sx={{color:"#cdcdcd"}}><TwitterIcon /></IconButton>
                    <IconButton href = "https://github.com/CodeIIEST-dev" target="_blank" rel="noopener noreferrer" className="iconhover" sx={{color:"#cdcdcd"}}><GitHubIcon /></IconButton>
                    <IconButton href = "https://www.facebook.com/CodeIIEST" target="_blank" rel="noopener noreferrer" className="iconhover" sx={{color:"#cdcdcd"}}><FacebookIcon /></IconButton>
                    <IconButton href = "codeiiest.iiest@gmail.com" target="_blank" rel="noopener noreferrer" className="iconhover" sx={{color:"#cdcdcd"}}><MailIcon /></IconButton>
                    <IconButton className = "iconhover" href = "https://www.youtube.com/codeiiest" target="_blank" rel="noopener noreferrer" sx={{color:"#cdcdcd"}}><YouTubeIcon /></IconButton>
                </Box>

    ...
    <Box sx={{ paddingTop: "2rem", background: "hsl(0, 0%, 95%)" }}>
      ...
      >
        ...
        >
          ...
          is an intensive learning program designed to introduce participants to
          cloud computing concepts and technologies over a 30-day period.
          <br />
          Throughout this program, participants engage in various activities,
          labs, and challenges that cover the fundamentals of cloud computing
        ...
        >
          It is an excellent opportunity for students, professionals, and anyone
          interested in cloud technology to gain foundational knowledge and
          hands-on experience. It provides a structured learning path that can
          serve as a stepping stone for further exploration and specialization
          in cloud computing.
        </Typography>
      </Box>
      ...
      >
        ...
        >
          Along the way, you will learn and practice concepts like computing,
          application development, big data and machine learning using cloud and
          if you get stuck, you will have your "Facilitators" who are specially
          trained on Google Cloud to help.
        </Toolbar>
